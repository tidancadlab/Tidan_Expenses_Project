...
function DashBoard(props) {
  ...
  return (
    <>
      {loggedUser.userId === params.id ? (
        <div className="bg-gray-400 dark:bg-gray-900 pt-20 min-h-[calc(100vh)]">
          ...
          <div className="container m-auto bg-white rounded-2xl p-8 mt-8">
