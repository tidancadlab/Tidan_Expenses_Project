...
function AppSearchBar(props) {
  ...
  return (
    <>
      <div className="bg-[#F26666] fixed dark:bg-slate-700 dark:text-white w-full upto-lab-s:px-1 px-4 flex upto-lab-s:h-12 h-14">
        <div className="flex w-full upto-lab-s:gap-2 gap-5 items-center">
          <div className="flex flex-row upto-lab-s:gap-2 gap-5 items-center">
            <div className="upto-lab-s:hidden">
              <div
                onClick={() => {
                  setSideBarExtendBtn((sideBarExtendBtn) =>
                    sideBarExtendBtn ? false : true
                  );
                }}
          ...
          <div className="relative upto-lab-s:w-full upto-lab-s:min-w-[250px] w-full h-10 upto-lab-s:h-8 scrn-mob:max-w-[200px] dark:border-none">
            <input
              ...
              id=""
            />
            <div className="absolute cursor-pointer flex items-center justify-center rounded-r w-10 h-full active:bg-red-300 ease-in-out duration-150 hover:bg-red-400 top-1/2 right-0 -translate-y-1/2">
              <BsSearch className="dark:fill-white" />
            </div>
          </div>
          <div className="relative max-w-[180px] upto-lab-s:w-fit w-full">
            <div
              tabIndex="0"
              onBlur={() => {
                setTimeout(() => {
            ...
            >
              ...
              <span className="upto-lab-s:hidden text-white">
                Praveen Kumar
              </span>
      ...
      <div className="h-14 upto-lab-s:h-12"></div>
    </>
  );
}
